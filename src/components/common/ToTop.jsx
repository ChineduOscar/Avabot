...
const ToTop = () => {
  ...
  return (
    <div className={`${visible? "block" : "hidden"} px-3 py-4 bg-white hover:bg-[#FF931E] rounded-[50%] cursor-pointer border-[1px] border-[#FF931E] shadow-2xl`} onClick={scrollToTop}>
